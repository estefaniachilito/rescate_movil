...
export const createMunicipality = async (req, res) => {
    try {
        ...
        // Realiza una consulta para insertar un nuevo municipio en la tabla 'municipios'
        const [result] = await pool.query('insert into municipios (name) values (?)', [name]);
...
export const updateMunicipality = async (req, res) => {
    try {
        ...
        const [oldMunicipality] = await pool.query('select * from municipios where id = ?', [id]);
        ...
        // Realiza una consulta para actualizar el municipio en la tabla 'municipios'
        const [result] = await pool.query('update municipios set ? where id = ?', [data, id]);
...
export const deleteMunicipality = async (req, res) => {
    try {
        ...
        const [result] = await pool.query('delete from municipios where id = ?', [id]);
