...
export const createUser = async (req, res) => {
    try {
        ...
        const [result] = await pool.query('insert into usuarios (name, email, password, phone, identification) values (?, ?, ?, ?, ?)', [name, email, password, phone, identification])
...
export const updateUser = async (req, res) => {
    try {
        ...
        const [result] = await pool.query('update usuarios set name=?, email=?, password=?, phone=?, identification=?, role=? where id = ?', [data.name, data.email, data.password, data.phone, data.identification, data.role, id])
