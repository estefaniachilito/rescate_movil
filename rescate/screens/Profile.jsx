        ...
        <SafeAreaView style={{ flex: 1 }}>
            <ScrollView>
                <View style={{ padding: 20, width: '100%', display: 'flex', flexDirection: 'column', gap: 5 }}>
                    ...
                    <Button title={'Actualizar'} buttonStyle={{ backgroundColor: '#9C50C4', padding: 10, borderRadius: 10 }} onPress={handleEdit} />
                    <TouchableOpacity onPress={() => handleLogout()}>
                        <Text style={{ textAlign: 'center', marginVertical: 10, fontWeight: 'bold', fontSize: 16, backgroundColor: '#9C50C4', padding: 10, borderRadius: 10, color: 'white'}}>Cerrar Sesión</Text>
                    </TouchableOpacity>
                    {
