...
const AddMunicipalities = () => {
  ...
  const createMunicipality = async () => {
    ...
    if (municipalityName === '') {
      return ToastAndroid.show('Ingresa un nombre para el municipio', ToastAndroid.SHORT);
    }
  ...
  return (
    <View style={styles.container}>
      <View style={styles.card}>
        ...
        <Button title="Añadir" onPress={showModal} color="purple"/>
      </View>
        ...
        <View style={styles.modalContainer}>
          <View style={styles.modalContent}>
            ...
            <View style={styles.buttonContainer}>
              <Button title="Cancelar" onPress={hideModal} color="purple"/>
              <Button title="Crear" onPress={createMunicipality} color="purple"/>
            </View>
          </View>
        </View>
      </Modal>
